import millions from './stories/millions.js'
const stories = [
  { title: "test", content: "content test", render: (place, noun, secondNoun, rhymesWithSecondNoun, typeOfBuilding, adjective, appendage, typeOfFood) => `
  "Movin' to the ${place}
  ...
  Look out"
  ` },
  { title: "test2", content: "This comes from an array" },
  { title: "test3", content: "And can be stored here" },
];
